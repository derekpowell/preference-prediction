...
```{r}
embedding_matrix <- similarity %>%
  select(V1, V2, V3) %>%
  as.matrix()

distance_matrix <- dist(embedding_matrix, method = "euclidean")

distance_matrix <- as.matrix(distance_matrix)

rownames(distance_matrix) <- similarity$Artwork_ID
colnames(distance_matrix) <- similarity$Artwork_ID
